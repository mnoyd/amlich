# Requirements Archive: v1.4 Lunar Engine Table Parity
...
- **Validated:** HP-01..05, SC-01..05, NAM-API-01..06, PAR-01..04 (20/20)
- **Adjusted:** SC-05 traceability status label corrected during archival (implementation and verification were already complete)
- **Dropped:** None

For active milestone requirements, see `.planning/REQUIREMENTS.md` (fresh file created at next milestone kickoff).
...
*Archived: 2026-03-04 after v1.4 milestone completion*
