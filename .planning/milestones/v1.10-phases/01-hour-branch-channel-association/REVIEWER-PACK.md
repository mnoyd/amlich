...
"sources": [{
  ...
  "passage_key": "十二經納地支歌",
  "edition_or_facsimile_uri": "<filled by classical reviewer on sign-off>",
...
- **`ty-ngo-luu-chu` is never emitted.** A separate CI guard (`prohibited_ty_ngo_luu_chu_emission`) fails the build if the string `"ty-ngo-luu-chu"` appears anywhere under `crates/amlich-core/src/`. This enforces the ADR-0003 scope split.
