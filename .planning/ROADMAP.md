...
- [x] `09-01-PLAN.md` - Add core->DTO Na Am API models and lookup handlers (completed 2026-03-03)
- [x] `09-02-PLAN.md` - Harden error contracts, schema tests, and requirement traceability sync (completed 2026-03-04)
