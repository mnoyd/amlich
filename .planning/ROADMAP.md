...
- [ ] **Phase 19: `RecommendsOffering` Semantic-Graph Node + v1.6 Integration** - Promote offerings to first-class nodes (Ritual → Offering via `RecommendsOffering` edge with dual-source provenance); v1.5→v1.6 backward-compat round-trip + 2026 E2E smoke. *(in progress — 19-01 complete)*
...
**Requirements**: INT-07, INT-08 (✅ closed 19-01), INT-09, INT-10
...
| 19. `RecommendsOffering` Semantic-Graph Node + v1.6 Integration | 1/3 | In progress | - |
...
*Last updated: 2026-07-15 — v1.6 roadmap (Phases 16-19, 11 plans, 12/12 requirements mapped). Phase 19 in progress (19-01 complete: OfferingRef schema + SourceId alias + DaySnapshot additive fields; INT-08 closed).*
