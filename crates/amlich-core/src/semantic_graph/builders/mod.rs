...
pub use interaction::{
    ...
    build_personal_hour_matrix_graph, project_day_person_matrix,
    project_direction_merge_matrix, project_domain_day_boost_matrix,
    project_element_resonance_matrix, project_personal_hour_matrix, InteractionGraphBuilder,
};
