...
impl InsightTab {
    pub fn next(self) -> Self {
        match self {
            ...
            InsightTab::Almanac => InsightTab::Hours,
            InsightTab::Hours => InsightTab::Elements,
    ...
    pub fn prev(self) -> Self {
        match self {
            ...
            InsightTab::Hours => InsightTab::Almanac,
            InsightTab::Elements => InsightTab::Hours,
    ...
    pub fn name(self, lang: InsightLang) -> &'static str {
        match (self, lang) {
            ...
            (InsightTab::Hours, InsightLang::Vi) => "Giờ",
            (InsightTab::Hours, InsightLang::En) => "Hours",
            (InsightTab::Elements, InsightLang::Vi) => "Ngũ hành",
            (InsightTab::Elements, InsightLang::En) => "Elements",
            (InsightTab::FengShui, InsightLang::Vi) => "Phong thủy",
            (InsightTab::FengShui, InsightLang::En) => "Feng Shui",
